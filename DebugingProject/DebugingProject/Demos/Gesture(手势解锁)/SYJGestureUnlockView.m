...
@interface SYJGestureUnlockView ()
...
@implementation SYJGestureUnlockView
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    if ([self.delegate respondsToSelector:@selector(unlockPassword:unLockView:)]) {
        [self.delegate unlockPassword:pwdStr unLockView:self];
    }
