 ...
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(43,164,202,1)

/**
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor rgba(34,157,187,1)
 ...
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor rgba(34,157,187,1)
 ...
 *  选中状态下三角形颜色
 */
#define CircleStateSelectedTrangleColor rgba(34,157,187,1)
...
/**
 *  整个解锁View的Center.y值 在当前屏幕的3/6位置
 */
#define CircleViewCenterY kScreenH * 3/6
...
FOUNDATION_EXPORT CGFloat const kCircleSetCountLease;
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState rgba(169,169,169,1)
 ...
 */
#define forgetPassWordTextColor  rgba(169,169,169,1)
/**
 *  绘制解锁界面准备好时，提示文字
 */
...
@interface SYJGestureConst : NSObject
